    ...
    Rating.prototype = {
        ...
        _parseAttr: function (vattr, options) {
            ...
            if ($input.attr('type') === 'range' || $input.attr('type') === 'number') {
                ...
                // 20170127 liuren 修改设置初始数据代码
                else if (vattr === 'initialValue') {
                	chk = DEFAULT_INITVAL;
                }
...
//            self.initialValue = self.$element.val();
            self.initialValue = (typeof options.initialValue !== 'undefined') ? options.initialValue : self._parseAttr('initialValue', options);
            ...
            // 20170127 liuren 修改设置初始数据代码
            if (isNaN(self.initialValue) || isEmpty(self.initialValue) || self.initialValue == 0) {
                self.initialValue = DEFAULT_INITVAL;
            }
